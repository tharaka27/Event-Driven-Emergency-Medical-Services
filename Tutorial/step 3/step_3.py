...
if __name__=="__main__":
    # tiny demo
    calls=[Call(0,0.0,30.0,(11,10),"cardiac"),
           Call(1,120.0,20.0,(14,10),"catA")]
    stations={0:Station(0,(10,10)),1:Station(1,(8,8))}
    vehicles={0:Vehicle(0,"A",0,stations[0].grid_rc),
              1:Vehicle(1,"A",1,stations[1].grid_rc)}
    travel=Travel()
    sim=Simulation(calls,stations,vehicles,travel)
    print(sim.run(0.0,3600.0))